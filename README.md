...
The 'poc_databricks_evalueserve' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/poc_databricks_evalueserve/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] poc_databricks_evalueserve_etl` to your workspace.
